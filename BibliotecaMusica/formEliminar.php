...
<body>
    ...
    <main>
        <div class="container">
            <form action="eliminar.php" method="post" name="Form2" id="msform">
                <fieldset>
                    ...
                    if (isset($_GET['error'])) {
                        ...
                        echo '<h3 class="fs-subtitle">Eliminar canción</h3>';
                    }
                    ?>
                    <br>
                    ...
                    <div class="input-group">
                        <div class="input-box">
                            <input type="number" id="idEliminar" name="idEliminar" placeholder="Ingresa el ID canción"
                                required>
                        </div>
                    </div>
